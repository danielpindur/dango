...
namespace Test
{
    public class MyRegistrar : ITofuMapperRegistrar
    {
        ...
        Assert.That(result.Diagnostics, Is.Empty);
        Assert.That(result.Results.Single().GeneratedSources.Single().HintName, Is.EqualTo("Test_Api_TestEnumExtensions.g.cs"));
        
        var generatedSource = result.GeneratedTrees[0].ToString();
        
        Assert.That(generatedSource, Does.Contain("namespace Test.Assembly.Generated.Tofu.Mappings"));
        Assert.That(generatedSource, Does.Contain("public static class Test_Api_TestEnumExtensions"));
        
        Assert.That(generatedSource, Does.Contain("public static Test.Service.Api.TestEnum ToServiceTestEnum(this Test.Api.TestEnum value)"));
...
namespace Test
{
    public class MyRegistrar : ITofuMapperRegistrar
    {
        ...
        Assert.That(result.Diagnostics, Is.Empty);
        Assert.That(result.Results.Single().GeneratedSources.Single().HintName, Is.EqualTo("Test_Service_TestEnumExtensions.g.cs"));
        
        var generatedSource = result.GeneratedTrees[0].ToString();
        
        Assert.That(generatedSource, Does.Contain("namespace Test.Assembly.Generated.Tofu.Mappings"));
        Assert.That(generatedSource, Does.Contain("public static class Test_Service_TestEnumExtensions"));
        
        Assert.That(generatedSource, Does.Contain("public static Test.Service.Api.TestEnum ToApiTestEnum(this Test.Service.TestEnum value)"));
...
namespace Test
{
    public class MyRegistrar : ITofuMapperRegistrar
    {
        ...
        Assert.That(result.Diagnostics, Is.Empty);
        Assert.That(result.Results.Single().GeneratedSources.Single().HintName, Is.EqualTo("Test_Service_Api_TestEnumExtensions.g.cs"));
        
        var generatedSource = result.GeneratedTrees[0].ToString();
        
        Assert.That(generatedSource, Does.Contain("namespace Test.Assembly.Generated.Tofu.Mappings"));
        Assert.That(generatedSource, Does.Contain("public static class Test_Service_Api_TestEnumExtensions"));
        
        Assert.That(generatedSource, Does.Contain("public static Test.Service.TestEnum ToTestEnum(this Test.Service.Api.TestEnum value)"));
